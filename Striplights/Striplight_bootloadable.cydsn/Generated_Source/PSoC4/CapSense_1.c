...
reg32 * CapSense_1_pcTable[] = {
    ...
    (reg32 *)CapSense_1_Sns__Button1__BTN__PC, 
    (reg32 *)CapSense_1_Sns__Button2__BTN__PC, 
    (reg32 *)CapSense_1_Sns__Button3__BTN__PC, 
    (reg32 *)CapSense_1_Sns__Button4__BTN__PC, 
    (reg32 *)CapSense_1_Sns__Button5__BTN__PC, 
    (reg32 *)CapSense_1_Sns__Button6__BTN__PC, 
    (reg32 *)CapSense_1_Sns__Button7__BTN__PC, 
};

const uint8 CapSense_1_portTable[] = {
    CapSense_1_Sns__Button0__BTN__PORT, 
    CapSense_1_Sns__Button1__BTN__PORT, 
    CapSense_1_Sns__Button2__BTN__PORT, 
    CapSense_1_Sns__Button3__BTN__PORT, 
    CapSense_1_Sns__Button4__BTN__PORT, 
    CapSense_1_Sns__Button5__BTN__PORT, 
    CapSense_1_Sns__Button6__BTN__PORT, 
    CapSense_1_Sns__Button7__BTN__PORT, 
};

const uint32 CapSense_1_maskTable[] = {
    CapSense_1_Sns__Button0__BTN__MASK, 
    CapSense_1_Sns__Button1__BTN__MASK, 
    CapSense_1_Sns__Button2__BTN__MASK, 
    CapSense_1_Sns__Button3__BTN__MASK, 
    CapSense_1_Sns__Button4__BTN__MASK, 
    CapSense_1_Sns__Button5__BTN__MASK, 
    CapSense_1_Sns__Button6__BTN__MASK, 
    CapSense_1_Sns__Button7__BTN__MASK, 
};

const uint8 CapSense_1_pinShiftTbl[] = {
    (uint8) CapSense_1_Sns__Button0__BTN__SHIFT, 
    (uint8) CapSense_1_Sns__Button1__BTN__SHIFT, 
    (uint8) CapSense_1_Sns__Button2__BTN__SHIFT, 
    (uint8) CapSense_1_Sns__Button3__BTN__SHIFT, 
    (uint8) CapSense_1_Sns__Button4__BTN__SHIFT, 
    (uint8) CapSense_1_Sns__Button5__BTN__SHIFT, 
    (uint8) CapSense_1_Sns__Button6__BTN__SHIFT, 
    (uint8) CapSense_1_Sns__Button7__BTN__SHIFT, 
};
