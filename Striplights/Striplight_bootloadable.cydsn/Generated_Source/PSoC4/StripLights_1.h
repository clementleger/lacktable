...
#define StripLights_1_TRANSFER           1
...
#define StripLights_1_COLUMNS     12
#define StripLights_1_ROWS        12
#define StripLights_1_TOTAL_LEDS   (StripLights_1_COLUMNS*StripLights_1_ROWS)

#define StripLights_1_ARRAY_COLS  (int32)(12)
#define StripLights_1_ARRAY_ROWS  (int32)(12)
